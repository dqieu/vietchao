import {templateView,specificationSheet,machineRoomSheet} from './cad-template.mjs?v=20260924-template-review';
import {drawingFor} from './cad.mjs?v=20260924-template-review';
